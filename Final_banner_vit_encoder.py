...
def get_banner_vit_enc(uid,imgid, wavelet = 1, rgb = 1, way1 = 1, way2 = 1):
...
#    749003_banner.jpg    
    readfile = FOLDER + '\\' + uid + '\\' + uid + '_banner' + '.jpg'  
#    readfile = filepath
...
#    if(rgb_image.any() == None):
        print("Got no Banner here", uid, imgid)
...
# =============================================================================
    ...
    # =============================================================================
        ...
        rotated_grey_22 = imutils.rotate_bound(grey_0, -22.5)
    ...
    # =============================================================================
        ...
        rotated_grey_45 = imutils.rotate_bound(grey_0, -45)
        ...
        rotated_grey_77 = imutils.rotate_bound(grey_0, -77.5)
...
#     model=scaler.fit(img_encoding)
#     scaled_data=model.transform(img_encoding)
#     normalized_enc_flat = scaled_data.flatten()
# =============================================================================
